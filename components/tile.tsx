...
export const TileBackground = ({children} : {children: ReactNode}): ReactElement => (
    <div className="absolute h-full w-full">{children}</div>
)

export const TileContent = ({children} : {children: ReactNode}): ReactElement => (
...
export const Tile: React.FC<Props> = ({page, renderContent}) => {
    ...
    return (
        <div ref={refContainer} className="absolute top-0 w-full" style={{pointerEvents: progress <= 0 || progress >= 1 ? 'none' : undefined, opacity}}>
