...
export const WorkContainer = ({children} : {children: ReactNode}): ReactElement => (
...
export const WorkLeft: React.FC<{children:any, progress: number}> = ({children, progress}) => {
...
export const WorkRight: React.FC<{children:any, progress: number}> = ({children, progress}) => {
